 ...
 * @ControllerAnnotation(title="发送消息")
 */
class Sendnotice extends AdminController
{
    ...
    public function index()
    {
        if ($this->request->isAjax()) {
            ...
            try {
                ...
                // 创建日志
                UserMailLog::createLog('notice', $post, []);
    ...
    public function log()
    {
        if ($this->request->isAjax()) {
            ...
            $log  = $this->model->where('log_key', 'notice')->where($where);
