<?php /*a:2:{s:59:"C:\xampp\htdocs\YY\Bg\trunk\app\index\view\index\index.html";i:1647846847;s:62:"C:\xampp\htdocs\YY\Bg\trunk\app\index\view\layout\default.html";i:1647844460;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">
                        <img src="<?php echo session('admin.head_img'); ?>" class="layui-nav-img" width="40" height="40" data-image="<?php echo session('admin.head_img'); ?>">
                        <cite class="adminName" title="<?php echo session('admin.remark'); ?>"><?php echo session('admin.username'); ?></cite>
