...
class BuildCurd
{
    ...
    protected function buildViewJsUrl()
    {
        ...
        $this->controllerNamespace = empty($namespaceSuffix) ? "app\index\controller" : "app\index\controller\\{$namespaceSuffix}";
    ...
    protected function renderController()
    {
        ...
        $controllerValue = CommonTool::replaceTemplate(
            ...
            [
                ...
                'modelFilename'        => "\app\index\model\\{$modelFilenameExtend}",
    ...
    protected function renderModel()
    {
            ...
            foreach ($this->relationArray as $key => $val) {
                ...
                $relationCode = CommonTool::replaceTemplate(
                    ...
                    [
                        ...
                        'relationModel'  => "\app\index\model\\{$val['modelFilename']}",
        ...
        $modelValue = CommonTool::replaceTemplate(
            ...
            [
                ...
                'modelNamespace' => "app\index\model{$extendNamespace}",
                'table'          => $this->table,
