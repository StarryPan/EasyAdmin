define(["jquery", "easy-admin"], function ($, ea) {
    ...
    let init  = {
        ...
        index_url: 'user.senditem/log',
        copy_url: 'user.senditem/copy',
        ...
        log: function () {
            ...
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'rewards', width: 300, title: '奖励<br/>rewards', search: false, templet: ea.table.rewards, selectList: config_items},
