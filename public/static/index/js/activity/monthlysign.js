define(["jquery", "easy-admin", "jquery-json-viewer"], function ($, ea, jsonV) {
    ...
    let init = {
        ...
        index_url: 'activity.monthlysign/index',
        add_url: 'activity.monthlysign/add',
        edit_url: 'activity.monthlysign/edit',
        delete_url: 'activity.monthlysign/delete',
        modify_url: 'activity.monthlysign/modify',
        export_url: 'activity.monthlysign/export',
        import_url: 'activity.monthlysign/import',
    ...
    for (let day = 1; day <= 12; day++) {
        ...
        monthly_list[day] = day + '月';
    }
    
    rew_vue.monthly_list = monthly_list;
    ...
    var Controller = {
        ...
        index: function () {
            ...
            let cols = [
                ...
                {field: 'month', width: 80, title: 'month<br/>月份', search: false},
            ];
