    ...
    try {
        ...
        Db::connect('install')
            ...
            ->insert([
                'id'          => 1,
                'username'    => $username,
                'head_img'    => '/static/index/images/head.jpg',
    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="bg">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" class="layui-input" name="db_password" autocomplete="off" lay-reqtext="请输入数据库密码" placeholder="请输入数据库密码">
                </div>
            </div>
